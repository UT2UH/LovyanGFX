...
//static SharpDisplay lcd(SHARP_SCK, SHARP_MOSI, SHARP_SS, 336, 536);
...
//static SharpDisplay lcd(SHARP_SCK, SHARP_MOSI, SHARP_SS, 240, 240);
//static SharpDisplay lcd(SHARP_SCK, SHARP_MOSI, SHARP_SS, 144, 168);
...
static int32_t width = 399;             // 画像サイズ
