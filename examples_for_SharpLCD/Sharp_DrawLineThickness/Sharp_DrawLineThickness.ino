...
static SharpDisplay tft(SHARP_SCK, SHARP_MOSI, SHARP_SS, 336, 536);
//static SharpDisplay tft(SHARP_SCK, SHARP_MOSI, SHARP_SS, 400, 240, SHARP_DISPON);
//static K52SharpLCD tft;
//static SharpDisplay tft(SHARP_SCK, SHARP_MOSI, SHARP_SS, 230, 303);
//static SharpDisplay tft(SHARP_SCK, SHARP_MOSI, SHARP_SS, 240, 240);
//static SharpDisplay tft(SHARP_SCK, SHARP_MOSI, SHARP_SS, 144, 168);
